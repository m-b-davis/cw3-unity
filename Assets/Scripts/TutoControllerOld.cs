...
public class TutoControllerOld : MonoBehaviour
{
    ...
    void Update() {
        ...
        if (Input.GetAxis("Horizontal") != 0 && Input.GetAxis("Vertical") != 0) {
            leftStick.transform.localScale = Vector3.one;
        ...
        if (LS && LT && RT) {
            ...
            leftTrigger.GetComponent<Image>().color = new Color(color.r, color.g, color.b, color.a - 0.01f);
            rightTrigger.GetComponent<Image>().color = new Color(color.r, color.g, color.b, color.a - 0.01f);
            leftStick.GetComponent<Image>().color = new Color(color.r, color.g, color.b, color.a - 0.01f);
